...
export enum I18nKey {
  // Authentication keys
  AUTH$LOGIN_TO_OPENHANDS = "AUTH$LOGIN_TO_OPENHANDS",
  AUTH$ENTER_YOUR_CREDENTIALS = "AUTH$ENTER_YOUR_CREDENTIALS",
  AUTH$USERNAME = "AUTH$USERNAME",
  AUTH$USERNAME_PLACEHOLDER = "AUTH$USERNAME_PLACEHOLDER",
  AUTH$PASSWORD = "AUTH$PASSWORD",
  AUTH$PASSWORD_PLACEHOLDER = "AUTH$PASSWORD_PLACEHOLDER",
  AUTH$LOGIN = "AUTH$LOGIN",
  AUTH$DONT_HAVE_ACCOUNT = "AUTH$DONT_HAVE_ACCOUNT",
  AUTH$REGISTER = "AUTH$REGISTER",
  AUTH$CREATE_ACCOUNT = "AUTH$CREATE_ACCOUNT",
  AUTH$ENTER_DETAILS_TO_REGISTER = "AUTH$ENTER_DETAILS_TO_REGISTER",
  AUTH$EMAIL = "AUTH$EMAIL",
  AUTH$EMAIL_PLACEHOLDER = "AUTH$EMAIL_PLACEHOLDER",
  AUTH$CONFIRM_PASSWORD = "AUTH$CONFIRM_PASSWORD",
  AUTH$CONFIRM_PASSWORD_PLACEHOLDER = "AUTH$CONFIRM_PASSWORD_PLACEHOLDER",
  AUTH$ALREADY_HAVE_ACCOUNT = "AUTH$ALREADY_HAVE_ACCOUNT",
  AUTH$LOGIN_FAILED = "AUTH$LOGIN_FAILED",
  AUTH$REGISTRATION_FAILED = "AUTH$REGISTRATION_FAILED",
  AUTH$MY_PROFILE = "AUTH$MY_PROFILE",
  AUTH$VIEW_AND_MANAGE_YOUR_PROFILE = "AUTH$VIEW_AND_MANAGE_YOUR_PROFILE",
  AUTH$PROFILE_INFORMATION = "AUTH$PROFILE_INFORMATION",
  AUTH$VIEW_YOUR_ACCOUNT_DETAILS = "AUTH$VIEW_YOUR_ACCOUNT_DETAILS",
  AUTH$ACCOUNT_CREATED = "AUTH$ACCOUNT_CREATED",
  AUTH$LAST_LOGIN = "AUTH$LAST_LOGIN",
  AUTH$EMAIL_NOT_VERIFIED = "AUTH$EMAIL_NOT_VERIFIED",
  AUTH$LOGOUT = "AUTH$LOGOUT",
  AUTH$ACCOUNT_SETTINGS = "AUTH$ACCOUNT_SETTINGS",
  AUTH$MANAGE_YOUR_ACCOUNT_SETTINGS = "AUTH$MANAGE_YOUR_ACCOUNT_SETTINGS",

  // Webhook keys
  WEBHOOK$WEBHOOK_MANAGEMENT = "WEBHOOK$WEBHOOK_MANAGEMENT",
  WEBHOOK$MANAGE_YOUR_WEBHOOKS = "WEBHOOK$MANAGE_YOUR_WEBHOOKS",
  WEBHOOK$MY_WEBHOOKS = "WEBHOOK$MY_WEBHOOKS",
  WEBHOOK$WEBHOOK_LOGS = "WEBHOOK$WEBHOOK_LOGS",
  WEBHOOK$MANAGE_YOUR_WEBHOOK_CONFIGURATIONS = "WEBHOOK$MANAGE_YOUR_WEBHOOK_CONFIGURATIONS",
  WEBHOOK$ADD_WEBHOOK = "WEBHOOK$ADD_WEBHOOK",
  WEBHOOK$EDIT_WEBHOOK = "WEBHOOK$EDIT_WEBHOOK",
  WEBHOOK$DELETE_WEBHOOK = "WEBHOOK$DELETE_WEBHOOK",
  WEBHOOK$DELETE_WEBHOOK_CONFIRMATION = "WEBHOOK$DELETE_WEBHOOK_CONFIRMATION",
  WEBHOOK$NAME = "WEBHOOK$NAME",
  WEBHOOK$URL = "WEBHOOK$URL",
  WEBHOOK$REPOSITORY = "WEBHOOK$REPOSITORY",
  WEBHOOK$EVENTS = "WEBHOOK$EVENTS",
  WEBHOOK$STATUS = "WEBHOOK$STATUS",
  WEBHOOK$CREATED_AT = "WEBHOOK$CREATED_AT",
  WEBHOOK$ACTIVE = "WEBHOOK$ACTIVE",
  WEBHOOK$INACTIVE = "WEBHOOK$INACTIVE",
  WEBHOOK$NO_WEBHOOKS_FOUND = "WEBHOOK$NO_WEBHOOKS_FOUND",
  WEBHOOK$NAME_PLACEHOLDER = "WEBHOOK$NAME_PLACEHOLDER",
  WEBHOOK$NAME_DESCRIPTION = "WEBHOOK$NAME_DESCRIPTION",
  WEBHOOK$URL_DESCRIPTION = "WEBHOOK$URL_DESCRIPTION",
  WEBHOOK$EVENTS_DESCRIPTION = "WEBHOOK$EVENTS_DESCRIPTION",
  WEBHOOK$REPOSITORY_DESCRIPTION = "WEBHOOK$REPOSITORY_DESCRIPTION",
  WEBHOOK$SECRET = "WEBHOOK$SECRET",
  WEBHOOK$SECRET_PLACEHOLDER_EDIT = "WEBHOOK$SECRET_PLACEHOLDER_EDIT",
  WEBHOOK$SECRET_PLACEHOLDER_NEW = "WEBHOOK$SECRET_PLACEHOLDER_NEW",
  WEBHOOK$SECRET_DESCRIPTION = "WEBHOOK$SECRET_DESCRIPTION",
  WEBHOOK$SELECT_STATUS = "WEBHOOK$SELECT_STATUS",
  WEBHOOK$STATUS_DESCRIPTION = "WEBHOOK$STATUS_DESCRIPTION",
  WEBHOOK$WEBHOOK_FORM_DESCRIPTION = "WEBHOOK$WEBHOOK_FORM_DESCRIPTION",
  WEBHOOK$ALL_EVENTS = "WEBHOOK$ALL_EVENTS",
  WEBHOOK$PULL_REQUEST_EVENTS = "WEBHOOK$PULL_REQUEST_EVENTS",
  WEBHOOK$PUSH_EVENTS = "WEBHOOK$PUSH_EVENTS",
  WEBHOOK$ISSUE_EVENTS = "WEBHOOK$ISSUE_EVENTS",
  WEBHOOK$COMMENT_EVENTS = "WEBHOOK$COMMENT_EVENTS",
  WEBHOOK$ALL_REPOSITORIES = "WEBHOOK$ALL_REPOSITORIES",
  WEBHOOK$VIEW_WEBHOOK_DELIVERY_HISTORY = "WEBHOOK$VIEW_WEBHOOK_DELIVERY_HISTORY",
  WEBHOOK$FILTER_BY_WEBHOOK = "WEBHOOK$FILTER_BY_WEBHOOK",
  WEBHOOK$ALL_WEBHOOKS = "WEBHOOK$ALL_WEBHOOKS",
  WEBHOOK$EVENT_TYPE = "WEBHOOK$EVENT_TYPE",
  WEBHOOK$PR_NUMBER = "WEBHOOK$PR_NUMBER",
  WEBHOOK$RESPONSE_CODE = "WEBHOOK$RESPONSE_CODE",
  WEBHOOK$TIMESTAMP = "WEBHOOK$TIMESTAMP",
  WEBHOOK$NO_LOGS_FOUND = "WEBHOOK$NO_LOGS_FOUND",
  WEBHOOK$NOT_SPECIFIED = "WEBHOOK$NOT_SPECIFIED",
  WEBHOOK$LOG_DETAILS = "WEBHOOK$LOG_DETAILS",
  WEBHOOK$LOG_DETAILS_DESCRIPTION = "WEBHOOK$LOG_DETAILS_DESCRIPTION",
  WEBHOOK$ERROR_MESSAGE = "WEBHOOK$ERROR_MESSAGE",
